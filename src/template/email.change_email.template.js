...
export default (receiver_name = "ลูกค้า", email = "", role = "", email_token = "") => {
    const confirmemail_url = `${config.app.base_url}/account/email/change/receive/success?email_token=${email_token}`;
    return `
    <div>
        <h3>ข้อความสำหรับการยืนยันการเปลี่ยนแปลงอีเมลของคุณ</h3>
        <p>เรียน คุณ ${receiver_name}</p>
        <p>ทาง Logpost ได้รับคำขอจากคุณในเรื่องเปลี่ยนแปลงอีเมลเป็น ${email}</p>
        <p>ในการบัญชีผู้ใช้${role === "shipper" ? "ผู้ส่งสินค้า" : "ผู้ให้บริการขนส่งสินค้า"}</p>
